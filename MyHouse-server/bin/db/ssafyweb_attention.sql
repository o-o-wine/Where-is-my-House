...
CREATE TABLE `attention` (
  ...
  PRIMARY KEY (`aid`),
  KEY `atte_dongCode_fk_idx` (`dongCode`),
  KEY `atte_user_fk_idx` (`userId`),
  CONSTRAINT `atte_dongCode_fk` FOREIGN KEY (`dongCode`) REFERENCES `dongcode` (`dongCode`),
  CONSTRAINT `atte_user_fk` FOREIGN KEY (`userId`) REFERENCES `user` (`id`)
